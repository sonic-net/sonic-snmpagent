...
class TestSonicMIB(TestCase):
    ...
    def test_getnext_fdb_status(self):
        self.getnextpdu((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 2, 1,3),ValueType.INTEGER, 3, (1, 3, 6, 1, 2, 1, 17, 7, 1, 2,2,1,3,1000, 124, 254, 144, 128, 159, 4))
    ...
    def test_getnext_fdb_dynamic_count(self):
        self.getnextpdu((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 1, 1,2),ValueType.COUNTER_32, 2, (1, 3, 6, 1, 2, 1, 17, 7, 1, 2,1,1,2,1000 ))
