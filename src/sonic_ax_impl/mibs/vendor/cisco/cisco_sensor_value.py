...
from ...ietf.physical_entity_sub_oid_generator import CHASSIS_SUB_ID
from ...ietf.physical_entity_sub_oid_generator import get_transceiver_sensor_sub_id
from ...ietf.physical_entity_sub_oid_generator import get_fan_drawer_sub_id
from ...ietf.physical_entity_sub_oid_generator import get_fan_sub_id
from ...ietf.physical_entity_sub_oid_generator import get_fan_tachometers_sub_id
...
from ...ietf.sensor_data import ThermalSensorData, FANSensorData, PSUSensorData, TransceiverSensorData
...
class CiscoValuePhysicalSensorTableMIBUpdater(MIBUpdater):
    """
    Updater for sensors.
    """
