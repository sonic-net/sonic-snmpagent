...
class QueueStatUpdater(MIBUpdater):
    ...
    def reinit_data(self):
        ...
        self.port_queues_map, self.queue_stat_map, self.port_queue_list_map = \
            mibs.init_namespace_sync_d_queue_tables(self.db_conn)

        self.queue_type_map = mibs.get_all_from_namespace_dbs(self.db_conn, mibs.COUNTERS_DB, "COUNTERS_QUEUE_TYPE_MAP", blocking=False)
    ...
    def update_data(self):
        ...
        for queue_key, sai_id in self.port_queues_map.items():
            ...
            queue_stat = mibs.get_all_from_namespace_dbs(self.db_conn, mibs.COUNTERS_DB, queue_stat_name, blocking=False)
